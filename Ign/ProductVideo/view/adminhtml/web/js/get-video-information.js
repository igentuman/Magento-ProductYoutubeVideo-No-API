    ...
    'mage/translate'
            ...
            _create: function () {
                ...
                this._on(window, {
                    ...
                    'youtubeapiready': function () {
                        ...
                        self._params.rel = 0;
                        this.element.html('<iframe width="100%" height="100%"\n' +
                            'src="https://www.youtube.com/embed/'+ self._code+'">\n' +
                            '</iframe>')
                    }
                });
        ...
        $.widget('mage.videoData', {
            ...
            _onRequestHandler: function () {
                ...
                if (type === 'youtube') {
                    var dataUrl = window.getYoutubeVideoInfo + '?id='+id;
